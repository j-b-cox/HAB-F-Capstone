...
wavelengths = meta["wavelengths"]   # 1D array of combined wavelengths
date_list = meta["date_list"]       # list of "YYYY-MM-DD" strings

# arr_4d has shape (n_days, nlat, nlon, n_bands_combined)
# meta is a dict with keys: "wavelengths", "lat", "lon", "date_list"
